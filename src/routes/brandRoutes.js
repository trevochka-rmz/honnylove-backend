 ...
 *   "website": "https://example.com" (опционально, должно быть валидным URL),
 *   "logo_url": "/path/to/logo.jpg" (опционально),
 ...
 *   "highlights": ["Хайлайт 1", "Хайлайт 2"] (опционально, массив строк, по умолчанию [])
 * }
 */
router.post(
  '/',
 ...
 *   "logo_url": "/new/path.jpg" (опционально),
